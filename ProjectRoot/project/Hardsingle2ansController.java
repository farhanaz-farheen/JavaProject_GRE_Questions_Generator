 ...
 * @author User
 */
public class Hardsingle2ansController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
         ...
         if(warning.contains("15istaken")){
             score.setText("You've already taken this test before!");
         }
         else if(warning.contains("15isfree")){
