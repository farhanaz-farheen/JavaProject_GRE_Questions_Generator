 ...
 * @author User
 */
public class HardsingleansController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
         ...
         if(warning.contains("6istaken")){
             score.setText("You've already taken this test before!");
         }
         else if(warning.contains("6isfree")){
